        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                <div class="single-footer-widget instafeed-widget">
                    <h3>Customer Service</h3>
                    <ul>
                        <li><a href="#"><img src="/web/img/instafeed/1.jpg" alt=""></a></li>
                        <li><a href="#"><img src="/web/img/instafeed/2.jpg" alt=""></a></li>
                        <li><a href="#"><img src="/web/img/instafeed/3.jpg" alt=""></a></li>
                        <li><a href="#"><img src="/web/img/instafeed/4.jpg" alt=""></a></li>
                        <li><a href="#"><img src="/web/img/instafeed/5.jpg" alt=""></a></li>
                        <li><a href="#"><img src="/web/img/instafeed/6.jpg" alt=""></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="footer-copyright wow fadeIn">
                    ...
                    <p>Bản Quyền &copy;2020 Của Quang Châu Express</p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
