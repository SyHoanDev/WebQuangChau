        ...
        <div class="agile-grids">
            ...
            <div class="grids">
                <div class="progressbar-heading grids-heading">
                    <h2>DANH SÁCH LÝ DO CỦA DỊCH VỤ ${service.name.toUpperCase()}</h2>
                </div>
                ...
                <ul id="pagination"></ul>
                <div class="button-DV" style="width: 50%;margin: auto;margin-top: 40px;font-size: 20px">
                    <a href="/admin/listService"><input type="reset" value="Quay lại" id="cancel" style="width: 150px;color: #e94e02;border-radius: 10px"></a>
                    <a href="/admin/insertReason/${service.id}"><input type="submit" value="Thêm mới" id="continuee" style= "width: 150px;color: #449d44;margin-left: 100px;border-radius: 10px"></a>
